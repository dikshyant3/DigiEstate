...
async function main() {
  ...
  for (let i = 0; i < 7; i++) {
    const transaction = await realEstate.connect(seller).mint(`https://amber-additional-jay-734.mypinata.cloud/ipfs/Qmb9mgbuQT1oUcCGAnpKJrPAF5XGygfY2ivKsn5JQYNLvF/metadata_${i+1}.json`);
